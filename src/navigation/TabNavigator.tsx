...
const TabNavigator: React.FC = () => {
  const tabOptions = {
    headerShown: false,
    tabBarActiveTintColor: colors.tabTextActive,
    tabBarInactiveTintColor: colors.tabTextInactive,
    tabBarActiveBackgroundColor: colors.tabBackgroundActive,
    tabBarInactiveBackgroundColor: colors.tabBackgroundInactive,
    tabBarLabelStyle: {
      fontSize: 10,
      paddingBottom: 5,
    },
